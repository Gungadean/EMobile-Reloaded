...
public abstract class CellphoneSessionBase {
    ...
    public CellphoneSessionBase(String uuid, int duration) {
        this.duration = duration;
        CellphoneSessionsHandler.addSession(uuid, this);
        this.startCountdown();
    }
    ...
    public abstract boolean isPlayerInSession(PlayerEntity player);
}
